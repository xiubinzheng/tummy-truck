...
import com.xiubinzheng.tummytruck.data.AuthService;
...
public class LoginActivity extends AppCompatActivity {
    ...
    private void attemptLogin() {
        ...
        // check if the password is valid if the user has entered one
        ...
        if (cancel) {
            ...
            // display a progress spinner, and start a background task to
    ...
    /**
     *  hides the login form,and Show the progress UI.
     */
